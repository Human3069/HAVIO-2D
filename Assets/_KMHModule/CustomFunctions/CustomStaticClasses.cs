...
namespace _KMH_Framework
{
    public static class Vector3Ex
    {
        ...
        /// <summary>
        /// 유한한 두 점 사이의 직선에서 가장 가까운 점을 구합니다.
        /// </summary>
        /// <param name="targetPoint">해당 값으로부터 가까운 점을 계산</param>
        /// <param name="startPoint">선분의 시작점</param>
        /// <param name="endPoint">선분의 끝점</param>
        /// <returns>startPoint와 endPoint 사이에서의 가장 가까운 점을 리턴합니다.</returns>
        ...
        public static Vector3 GetClosestPointOnFinite(this Vector3 targetPoint, Vector3 startPoint, Vector3 endPoint)
        {
            return GetClosestPointOnFiniteLine(targetPoint, startPoint, endPoint);
        }
